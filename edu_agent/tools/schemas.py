    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "cpu_time_limit_seconds": {"type": "integer", "minimum": 1, "maximum": 10, "default": 2},
                "wall_time_limit_seconds": {"type": "integer", "minimum": 1, "maximum": 15},
                "memory_limit_mb": {
                    "type": "integer",
                    "minimum": 384,
                    "maximum": 1024,
                ...
                "output_limit_bytes": {"type": "integer", "minimum": 1024, "maximum": 131072, "default": 65536},
                "process_limit": {"type": "integer", "minimum": 1, "maximum": 32, "default": 16},
                "file_size_limit_mb": {"type": "integer", "minimum": 1, "maximum": 32, "default": 16},
                "artifact_limit_bytes": {"type": "integer", "minimum": 1024, "maximum": 262144, "default": 262144},
                "network_policy": {"type": "string", "enum": ["disabled"], "default": "disabled"},
                "network_allowlist": {"type": "array", "maxItems": 0, "items": {"type": "string"}},
            },
